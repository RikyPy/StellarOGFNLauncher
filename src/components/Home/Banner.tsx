  ...
  const LaunchPosts = [
    {
      ...
      banner: "https://wallpapercave.com/wp/wp5608087.jpg",
    },
    {
      title: "Challenges & XP",
      description:
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between gap-4 pt-2">
              <button className="px-6 py-2 bg-white/10 cursor-pointer hover:bg-white/20 border border-white/20 text-white rounded-md font-semibold text-sm transition-all flex items-center gap-2 backdrop-blur-sm hover:scale-[1.03] active:scale-[0.98]">
                Play Now
              </button>
